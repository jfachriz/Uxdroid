...
TARBALL_URL['aarch64']="https://github.com/RandomCoderOrg/ubuntu-on-android/releases/download/v3/uxdroid-mate-arm64-betav2.tar.gz"
...
distro_setup() {
      curl -L -o force_upgrade_to_jammy.sh https://raw.githubusercontent.com/jfachriz/fs-manager-uxdroid/main/scripts/upgrade_patch/upgrade.sh
